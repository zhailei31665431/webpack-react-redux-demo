...
/***/ function(module, exports, __webpack_require__) {
	...
	var _underscore = __webpack_require__(195);
	...
	function moveView(text) {
		return { type: MoveView, text: text };
	}
	...
	var initialState = {
		...
		scrollTop: 0,
		list: [],
		sidbarList: [{ id: '1', val: '1', child: [{ id: '1-1', val: '1-1' }] }]
	};
	...
	var SidbarItem = _react2.default.createClass({
		displayName: 'SidbarItem',
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ 'class': 'sidbar-item-show' },
					_react2.default.createElement('div', { 'class': 'sidbar-item-show-bg' }),
					_react2.default.createElement(
						'div',
						{ 'class': 'sidbar-item-show-val' },
						'字体图标'
					)
				),
				_react2.default.createElement('ul', { className: 'sidbar-item-child-list' })
			);
		}
	});
	var Sidbar = _react2.default.createClass({
		displayName: 'Sidbar',
		render: function render() {
			return _react2.default.createElement(
				'ul',
				{ className: 'sidbar' },
				_underscore2.default.map(this.props.sidbarList, function (p) {
					console.log(p);
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'section-item-w' },
						_react2.default.createElement(
							'div',
							{ className: 'section-h1-title' },
							'Icons'
						),
						_react2.default.createElement(
							'div',
						...
						_react2.default.createElement(
							'div',
							{ className: 'section-p' },
							'出于性能的考虑，所有图标都需要一个基类和对应每个图标的类。把下面的代码放在任何地方都可以正常使用。注意，为了设置正确的内补，务必在图标和文本之间添加一个空格。'
						),
						_react2.default.createElement(
							'div',
							{ className: 'section-important' },
							_react2.default.createElement('div', { className: 'section-important-border' }),
							_react2.default.createElement(
								'div',
								{ className: 'section-important-val' },
								_react2.default.createElement(
									'div',
									{ className: 'strong' },
									'不要和其他组件混合使用'
								...
								_react2.default.createElement(
									'div',
									null,
									'图标类不能和其它组件直接联合使用。它们不能在同一个元素上与其他类共同存在。应该创建一个嵌套的标签，并将图标类应用到这个 <span> 标签上。'
								)
							)
						),
						_react2.default.createElement('div', { className: 'section-code-show' }),
						_react2.default.createElement(
							'div',
							{ className: 'highlight' },
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'code',
									{ className: 'language-html', 'data-lang': 'html' },
									_react2.default.createElement(
										'span',
										{ className: 'nt' },
										'<div'
	...
	var Controller = function (_Component) {
		...
		_createClass(Controller, [{
			...
			value: function render() {
				...
				var showView = _props.showView;
				var scrollTop = _props.scrollTop;
				var list = _props.list;
				var sidbarList = _props.sidbarList;

				console.log(dispatch, showView, scrollTop, list, sidbarList);
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(Sidbar, null),
					_react2.default.createElement(
						'section',
						{ className: 'main' },
